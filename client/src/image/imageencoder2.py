...
# shutil.copy2("nakagawa.jpg", "nakagawa2.jpg")

img = cv2.imread('nakagawa.jpg')
img2 = cv2.imread('nakagawa2.jpg')
...
#encode(img2, "Lizeth")
img3 = cv2.imread('nakagawa2.jpg')
difference = cv2.subtract(img2, img)
#print(difference)
img4 = cv2.imread('lucero.jpg')
